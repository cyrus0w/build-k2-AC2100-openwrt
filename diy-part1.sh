...
sed -i "/exit 0/i\uci commit network" /workdir/openwrt/package/lean/default-settings/files/zzz-default-settings
sed -i "/exit 0/i\uci commit wireless" /workdir/openwrt/package/lean/default-settings/files/zzz-default-settings
